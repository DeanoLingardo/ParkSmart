...
"resource": {
  ...
  "rules":[
    ...
    [["if",1,5],["add",5]],
    [["if",1,6],["add",6]],
    [["if",1,7],["add",7,17,24,27,42,53,54]],
    [["if",1,8],["add",8,17]],
    [["if",9,10],["add",8,17,47]],
    [["if",1,11],["add",9,17]],
    [["if",10,12],["add",9,17,51]],
    [["if",1,13],["add",10,17,27,42,45,53]],
    [["if",14],["add",11,16,19,30,34,40,48,52]],
    [["if",15],["add",12,15,19,29,33,40,43,44]],
    [["if",1,16],["add",13]],
    [["if",17],["add",14,18]],
    [["if",18],["add",20,46,38,39]],
    [["if",1,19],["add",21]],
    [["if",1,20],["add",22]],
    [["if",21],["add",23,28,35,42,49]],
    [["if",1,22],["add",25]],
    [["if",23],["add",26,31,36,41,50]],
    [["if",1,24],["add",37]],
    [["if",25,26],["block",42]]]
},
"runtime":[
...
var Ag={"":"n",UA:"u",AW:"a",DC:"d",G:"e",GF:"f",HA:"h",GTM:yg},Bg=function(a){var b=D.o.split("-"),c=b[0].toUpperCase(),d=Ag[c]||"i",e=a&&"GTM"===c?b[1]:"",g;if(3===D.rb.length){var h=void 0;g="2"+(h||"w")}else g="";return g+d+D.rb+e};
var Cg=function(a){return!(void 0===a||null===a||0===(a+"").length)},Dg=function(a,b){var c;if(2===b.J)return a("ord",sa(1E11,1E13)),!0;if(3===b.J)return a("ord","1"),a("num",sa(1E11,1E13)),!0;if(4===b.J)return Cg(b.sessionId)&&a("ord",b.sessionId),!0;if(5===b.J)c="1";else if(6===b.J)c=b.Hc;else return!1;Cg(c)&&a("qty",c);Cg(b.ub)&&a("cost",b.ub);Cg(b.transactionId)&&a("ord",b.transactionId);return!0},Eg=encodeURIComponent,Fg=function(a,b){function c(a,b,c){g.hasOwnProperty(a)||(b+="",e+=";"+a+"="+
(c?b:Eg(b)))}var d=a.kc,e=a.protocol;e+=a.Db?"//"+d+".fls.doubleclick.net/activityi":"//ad.doubleclick.net/activity";e+=";src="+Eg(d)+(";type="+Eg(a.nc))+(";cat="+Eg(a.Oa));var g=a.nf||{};ta(g,function(a,b){e+=";"+Eg(a)+"="+Eg(b+"")});if(Dg(c,a)){Cg(a.Jb)&&c("u",a.Jb);Cg(a.Ib)&&c("tran",a.Ib);c("gtm",Bg());!1===a.Me&&c("npa","1");if(a.hc){var h=vg("dc",a.wa);h&&h.length&&c("gcldc",h.join("."));var k=vg("aw",a.wa);k&&k.length&&c("gclaw",k.join("."));var l=wg();l&&c("gac",l);Ef(a.wa,void 0,a.hf,a.jf);
var m=Af[Bf(a.wa)];m&&c("auiddc",m)}Cg(a.Dc)&&c("prd",a.Dc,!0);ta(a.Qc,function(a,b){c(a,b)});e+=b||"";Cg(a.Bb)&&c("~oref",a.Bb);a.Db?Ra(e+"?",a.H):Sa(e+"?",a.H,a.M)}else z(a.M)};var Ig=!!u.MutationObserver,Jg=void 0,Kg=function(a){if(!Jg){var b=function(){var a=x.body;if(a)if(Ig)(new MutationObserver(function(){for(var a=0;a<Jg.length;a++)z(Jg[a])})).observe(a,{childList:!0,subtree:!0});else{var b=!1;y(a,"DOMNodeInserted",function(){b||(b=!0,z(function(){b=!1;for(var a=0;a<Jg.length;a++)z(Jg[a])}))})}};Jg=[];x.body?b():z(b)}Jg.push(a)};var bh=u.clearTimeout,ch=u.setTimeout,Q=function(a,b,c){if(se()){b&&z(b)}else return Pa(a,b,c)},dh=function(){return new Date},R=function(){return u.location.href},eh=function(a){return C(db(a),"fragment")},fh=function(a){return cb(db(a))},T=function(a,b){return Ic(a,b||2)},gh=function(a,b,c){b&&(a.eventCallback=b,c&&(a.eventTimeout=c));return Ge(a)},hh=function(a,b){u[a]=b},U=function(a,b,c){b&&(void 0===u[a]||c&&
...
Y.a.flc=[],function(){function a(a,c){c=c?c.slice(0,-1):void 0;Fg(a,c)}(function(a){Y.__flc=a;Y.__flc.g="flc";Y.__flc.h=!0;Y.__flc.b=0})(function(b){var c=!b.hasOwnProperty("vtp_enableConversionLinker")||b.vtp_enableConversionLinker,d=X(b.vtp_customVariable||[],"key","value")||{},e={Oa:b.vtp_activityTag,hc:c,wa:b.vtp_conversionCookiePrefix||void 0,ub:void 0,J:{UNIQUE:3,SESSION:4}[b.vtp_ordinalType]||2,kc:b.vtp_advertiserId,nc:b.vtp_groupTag,M:b.vtp_gtmOnFailure,H:b.vtp_gtmOnSuccess,Bb:b.vtp_useImageTag?
void 0:b.vtp_url,protocol:"",Hc:void 0,Db:!b.vtp_useImageTag,sessionId:b.vtp_sessionId,Ib:b.vtp_transactionVariable,transactionId:void 0,Jb:b.vtp_userVariable,Qc:d};if(b.vtp_enableAttribution){var g=b.vtp_attributionFields||[];if(g.length){Q("//www.gstatic.com/attribution/collection/attributiontools.js",function(){a(e,U("google_attr").build([X(g,"key","value")||{}]))},b.vtp_gtmOnFailure);return}}a(e)})}();
...
Y.a.fls=[],function(){function a(a,c){c=c?c.slice(0,-1):void 0;Fg(a,c)}(function(a){Y.__fls=a;Y.__fls.g="fls";Y.__fls.h=!0;Y.__fls.b=0})(function(b){var c;if(b.vtp_enableProductReporting){var d=function(a){a=a||[];for(var b=[],c=[["i","id"],["p","price"],["q","quantity"],["c","country"],["l","language"],["a","accountId"]],d=0;d<a.length;d++)for(var e=0;e<c.length;e++){var g=c[e],h=a[d][g[1]];void 0!==h&&b.push(g[0]+(d+1)+
":"+W(h))}return b.join("|")};switch(b.vtp_dataSource){case "DATA_LAYER":c=d(T("ecommerce.purchase.products"));break;case "JSON":c=d(b.vtp_productData);break;case "STRING":for(var e=(b.vtp_productData||"").split("|"),g=0;g<e.length;g++){var h=e[g].split(":");h[1]=h[1]&&W(h[1])||"";e[g]=h.join(":")}c=e.join("|")}}var k=!b.hasOwnProperty("vtp_enableConversionLinker")||b.vtp_enableConversionLinker,l=X(b.vtp_customVariable||[],
"key","value")||{},m={Oa:b.vtp_activityTag,hc:k,wa:b.vtp_conversionCookiePrefix||void 0,ub:b.vtp_revenue,J:"ITEM_SOLD"===b.vtp_countingMethod?6:5,kc:b.vtp_advertiserId,nc:b.vtp_groupTag,M:b.vtp_gtmOnFailure,H:b.vtp_gtmOnSuccess,Bb:b.vtp_useImageTag?void 0:b.vtp_url,Dc:c,protocol:"",Hc:b.vtp_quantity,Db:!b.vtp_useImageTag,Ib:b.vtp_transactionVariable,transactionId:b.vtp_orderId,Jb:b.vtp_userVariable,Qc:l};if(b.vtp_enableAttribution){var n=b.vtp_attributionFields||[];if(n.length){Q("//www.gstatic.com/attribution/collection/attributiontools.js",
function(){a(m,U("google_attr").build([X(n,"key","value")||{}]))},b.vtp_gtmOnFailure);return}}a(m)})}();
